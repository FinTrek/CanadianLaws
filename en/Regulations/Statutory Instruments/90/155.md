...
- **(1)** Subject to subsection (2), the test thermal well required by section 24 shall be constructed so that the name or trademark of the manufacturer and the model number of the well are on the end fitting.
