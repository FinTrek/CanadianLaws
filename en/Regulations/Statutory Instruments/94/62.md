> [Go to French version](/fr/Règlements/Textes%20réglementaires/94/62.md)
...
> SI/94-92, s. 1; SI/95-84, s. 1; SI/2001-40, s. 3.
...
- **(2)** Where two bars are worn, the bar for Dieppe or the bar for Hong Kong shall be worn above the bar for overseas service, the two being evenly spaced on the ribbon.
> SI/94-92, s. 3; SI/95-84, s. 2.
...
- **(b)** the wearer has also been awarded the bar for Dieppe or the bar for Hong Kong, a second small silver maple leaf shall be attached to the ribbon beside the first maple leaf, the two being evenly spaced on the ribbon.
> SI/94-92, s. 3; SI/95-84, s. 3.
