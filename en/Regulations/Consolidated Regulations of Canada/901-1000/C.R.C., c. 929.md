> [Go to French version](/fr/Règlements/Codification%20des%20règlements%20du%20Canada/901-1000/C.R.C.,%20ch.%20929.md)
...
**1** These Regulations may be cited as the Hazardous Products (Matches) Regulations.
...
**3** Matches may be advertised, sold or imported into Canada only if
...
**6** Every book of matches shall meet the following requirements:
...
**7** The striking surface of a book of matches that is closed by a cover flap fitting in or over the base of the book shall be on the side of the book opposite to the side that opens.
...
**9** Where, in an inspection made pursuant to subsection 8(1),
...
- **(1)** A wooden block that is 7/8 inch (22mm) thick and two inches (50mm) square and that has a hole one inch (25mm) in diameter is placed on a flat surface.
...
- **(1)** The apparatus illustrated in Figure 1 is used to conduct this test.
...
> Image: Illustration depicting specifications of the apparatus used to test for breaking resistance of splints. The screw and pinion arrangement for lowering the holding clamp are shown. The moment arm where the matches are tested is perpendicular to the knife edge.
