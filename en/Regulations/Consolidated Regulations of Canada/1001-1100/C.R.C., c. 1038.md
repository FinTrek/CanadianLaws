...
<table>
<h4>Canada Motor Vehicle Safety Standards</h4>
<tr>
<th>Column I</th>
<th>Column II</th>
<th>Column III</th>
...
<tr>
<td>108</td>
<td>Lighting Systems and Reflective Devices</td>
<td>X</td>
<td>X</td>
<td>X</td>
<td>X</td>
...
<tr>
<td>108.1</td>
<td>[Repealed, SOR/2018-43, s. 3]</td>
</tr>
<tr>
<td>110</td>
<td>Tire Selection and Rims for Motor Vehicles With a GVWR of 4 536 kg or Less</td>
<td>X</td>
<td></td>
<td></td>
<td></td>
...
<tr>
<td>120</td>
<td>Tire Selection and Rims for Motor Vehicles With a GVWR of More Than 4 536 kg</td>
<td>X</td>
<td>X</td>
<td>X</td>
<td>X</td>
...
- **(1)** Every passenger car, multi-purpose passenger vehicle, truck, trailer and bus shall conform to Technical Standards Document No. 108, Lamps, Reflective Devices, and Associated Equipment (TSD 108), as amended from time to time.
...
- **(26)** Every vehicle shall be equipped with daytime running lamps
	...
	- **(c)** that conform to
		- **(i)** sections 5, 6 and 7.3.1 of SAE Standard J2087, except that despite section 6.1.2, if a daytime running lamp is optically combined with a white front position lamp that has a projected luminous lens area of 200 cm<sup>2</sup> or less, it may conform to the light intensity distribution values shown in figure 1 when tested in accordance with section 5.1, or
...
- **(1)** Every enclosed motorcycle shall be equipped at each designated seating position with a Type 2 manual seat belt assembly that
...
- **(1)** The following seat belt anchorages must be installed in a designated seating position in respect of which a seat belt assembly has been installed under section 208:
...
- **(1)** Every passenger car, other than a forward control configuration vehicle or an open-body type vehicle with a fold-down or removable windshield, shall conform to the requirements of Technical Standards Document No. 212, Windshield Mounting (TSD 212), as amended from time to time.
...
- **(1)** The following vehicles shall conform to the requirements of Technical Standards Document No. 214, Side Impact Protection (TSD 214), as amended from time to time:
...
- **(1)** Every passenger car, other than a forward control configuration vehicle or an open-body type vehicle with a fold-down or removable windshield, shall conform to the requirements of Technical Standards Document No. 219, Windshield Zone Intrusion (TSD 219), as amended from time to time.
...
- **(1)** Every school bus must conform to the requirements of Technical Standards Document No. 222, School Bus Passenger Seating and Crash Protection (TSD 222), as amended from time to time.
