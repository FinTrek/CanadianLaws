...
- **(a)** a particle accelerator with a beam energy equal to or greater than 50 MeV;
...
- **(i)** the proposed measures to prevent or mitigate the effects of accidental releases of nuclear substances and hazardous substances on the environment, the health and safety of persons and the maintenance of security, including an emergency response plan;
