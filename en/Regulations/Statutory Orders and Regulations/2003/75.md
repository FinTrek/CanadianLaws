...
- **(1)** Each producer shall pay, on each dozen of eggs marketed by the producer in interprovincial or export trade, a levy of
	...
	- **(c)** in the Province of Nova Scotia, $0.4115;
	- **(d)** in the Province of New Brunswick, $0.4460;
	- **(e)** in the Province of Manitoba, $0.3775;
	- **(f)** in the Province of British Columbia, $0.4242;
	- **(g)** in the Province of Prince Edward Island, $0.3765;
	- **(h)** in the Province of Saskatchewan, $0.4090;
	- **(i)** in the Province of Alberta, $0.4456;
	- **(j)** in the Province of Newfoundland and Labrador, $0.4025; and
	- **(k)** in the Northwest Territories, $0.4115.

- **(2)** Subsection (1) ceases to have effect on March 30, 2018.
