...
- **(1)** Each producer shall pay, on each dozen of eggs marketed by the producer in interprovincial or export trade, a levy of
	...
	- **(b)** in the Province of Quebec, $0.3375;
	- **(c)** in the Province of Nova Scotia, $0.3625;
	- **(d)** in the Province of New Brunswick, $0.3625;
	- **(e)** in the Province of Manitoba, $0.3375;
	- **(f)** in the Province of British Columbia, $0.3855;
	- **(g)** in the Province of Prince Edward Island, $0.3345;
	- **(h)** in the Province of Saskatchewan, $0.3690;
	- **(i)** in the Province of Alberta, $0.3510;
	- **(j)** in the Province of Newfoundland and Labrador, $0.3525; and
	- **(k)** in the Northwest Territories, $0.3715.
