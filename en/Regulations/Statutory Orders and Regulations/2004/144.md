...
- **(2)
** A commercial truck driver who is required to enter a restricted area two at a marine facility or port as part of their commercial activities may enter and remain in the area to carry out the activities if
...
- **(3)
** A passenger of a cruise ship may transit a restricted area two if the passenger uses a passageway that
...
- **(1)** A port administration may issue keys and restricted area passes, and keep an up-to-date list, by name and position, of the holders of security clearances, on behalf of marine facility operators in the port.
