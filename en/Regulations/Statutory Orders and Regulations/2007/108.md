...
- **(2)** The following uses are set out for the purpose of subsection (1):
	...
	- **(j)** presenting artistic, cultural, sporting and other community-related events; and
	- **(k)** storing any article or substance that is not hazardous to human beings or the environment.
...
- **(a)** the construction or installation does not result in a building with a footprint greater than 100 m<sup>2</sup> or a height greater than 5 m;
