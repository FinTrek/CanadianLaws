> [Go to French version](/fr/Règlements/Décrets,%20ordonnances%20et%20règlements%20statutaires/83/743.md)
...
***parcel compartment assembly*** means all parcel compartment units installed in an apartment building or office complex; (*batterie de casiers à colis*)
...
>  SOR/86-105, s. 4; SOR/87-567, s. 2; SOR/88-438, s. 1(E); SOR/98-558, s. 6(F).
...
>  SOR/86-105, s. 5(F); SOR/87-567, s. 3(F).
...
**2** Every mail box assembly shall be so constructed that a post office representative, when sorting the mail for that assembly, is not required to reach higher than 170 cm from the finished floor level in order to place mail in the top row of boxes in the assembly or lower than 45 cm from the finished floor level in order to place mail in the bottom row of boxes in the assembly.
...
**6** Each box in a mail box assembly shall have a holder in which the name and apartment number of the tenant may be placed in such a manner that the name and number will be readily visible to the post office representative when he is placing mail in the box.
...
- **(c)** where there is an open space or public foyer at both the front and rear of the assembly and the means of access described in paragraphs (a) and (b) are not reasonably obtainable, a cupboard type door on the rear of the assembly that
	...
	- **(ii)** is constructed of a metal, 20 mm plywood or other sturdy material,
	- **(iii)** is hinged so that the hinge or hinge pin cannot be removed from the outside when the doors are closed, and
	- **(iv)** has a master lock that is firmly anchored through the entire thickness of the door and, where the door is constructed of a material other than metal, is firmly anchored to a metal plate.
...
**11** Every box in a mail box assembly may be of a design that includes an opening not greater than 3.5 mm by 80 mm for the reception of calling cards, notices of telegrams and other similar items.
>  SOR/91-626, s. 1.
...
### **SCHEDULE IV** 
**(Paragraph 10(c))**
## Conditions and Specifications for Parcel Compartment Units in Apartment Buildings and Office Complexes
**1** Mail shall be delivered to parcel compartment units installed in an apartment building or office complex if
...
- **(f)** the interior dimensions of each storage compartment are not less than 30 cm by 34 cm by 50 cm; and
...
- **(1)** The Corporation shall install in each individual storage compartment a lock mechanism and provide a key for that mechanism.
