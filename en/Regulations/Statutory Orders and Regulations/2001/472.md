...
**3** For the purpose of subsection 445(4) of the Act, the agreement and information referred to in subsection 445(1) of the Act are deemed to have been provided by a bank to a customer
- **(a)** if the customer consents to receiving it by electronic means and it is sent by electronic means, on the day recorded by a server of the bank as the time of sending it to the customer;
- **(b)** if the customer consents to receiving it by fax and it is sent by fax, on the day recorded by a fax machine of the bank as the time of sending it to the customer;
