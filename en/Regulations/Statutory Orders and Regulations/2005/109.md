...
- **(1)** The concentration of total lead present in a surface coating material must not be more than 90 mg/kg when a dried sample of it is tested in accordance with a method that conforms to good laboratory practices.
...
- **(1)** If the concentration of total lead present in a surface coating material that is used for a purpose described in subsection 4(2) is more than 90 mg/kg, the display panel must contain the following information or its equivalent:**DANGER**
