...
***National Building Code of Canada***[Repealed, SOR/2017-116, s. 1]
...
- **(1)** At a workplace in which the total number of employees set out in column 1 of Schedule 5 is normally working, the total number of those employees who must be first aid attendants is set out in columns 2 to 4.
