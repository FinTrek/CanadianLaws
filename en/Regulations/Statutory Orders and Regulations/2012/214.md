...
***starch-modifying agent*** means a food additive that is used to modify the structural properties of a starch.

***List*** means the List of Permitted Starch-Modifying Agents published by the Department of Health on its website, as amended from time to time.
...
<a name='fn_Ind3851_hq_13311'><sup>*</sup></a>: [Note: Authorization not in force.]<br />
