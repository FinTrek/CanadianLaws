...
***List*** means the List of Permitted Sequestering Agents published by the Department of Health on its website, as amended from time to time.

***sequestering agent*** means a food additive that is used to control the availability of a cation.
...
<a name='fn_Ind382F_hq_13306'><sup>*</sup></a>: [Note: Authorization not in force.]<br />
