...
***assistance holdback amount*** means, at a particular time, the total amount of bonds and grants paid into an RDSP within the 10-year period before the particular time, less any amount of bond or grant paid in that 10-year period that has been repaid to the Minister. (*montant de retenue*)
...
- **(d)** the issuer shall report to the Minister annually or within any other period set out in the issuer agreement with respect to
	- **(i)** all contributions and transfers to, and all payments and transfers from, an RDSP,
