...
- **(1)** Subject to subsection 171(2), every operator shall ensure that every formation in a well is sampled or tested to obtain fluid flow and reservoir pressure data from the formation where there is an indication that the result of such a sample or test will contribute substantially to the evaluation of the formation.
...
- **(1)** Every operator shall submit to the Chief a detailed testing program prior to conducting the formation flow test referred to in subsection 170(2).

- **(2)** Every operator shall ensure that a formation flow test is not conducted without the prior approval, in writing, of the Board or any person designated by the Board.
