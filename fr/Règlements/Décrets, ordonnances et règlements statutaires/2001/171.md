...
- **D** :
- **(I)** s’agissant d’un montant de taxe visé à la subdivision (I) de l’élément C, la mesure dans laquelle le bien est livré ou rendu disponible avant le 1<sup>er</sup> octobre 2016 ou la mesure dans laquelle le service est rendu avant cette date,
- **(II)** s’agissant d’un montant de taxe visé à la subdivision (II) de l’élément C, le montant obtenu par la formule suivante :
```
E/F
```
où :
- **E** représente le nombre de jours de l’année déterminée donnée qui sont antérieurs au 1<sup>er</sup> octobre 2016,
- **F** le nombre de jours de l’année déterminée donnée,
- **(B)** dans les autres cas, le nombre de jours de la période de déclaration donnée qui sont antérieurs au 1<sup>er</sup> octobre 2016,
- **B** :
