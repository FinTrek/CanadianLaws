> [Aller à la version anglaise](/en/Regulations/Statutory%20Orders%20and%20Regulations/2001/101.md)
...
- **(3)** Pour l’application de l’article 451 de la Loi, le coût d’emprunt d’un prêt obtenu par utilisation d’une carte de crédit ou d’une marge de crédit aux termes d’une convention de crédit est exprimé sous forme d’un taux annuel, comme suit :
...
- **(6)** La déclaration est réputée fournie à l’emprunteur :
	- **a)** à la date d’envoi enregistrée par le serveur de la banque, si elle est envoyée par voie électronique;
...
- **(1)** La banque qui conclut une convention de crédit visant une carte de crédit doit remettre à l’emprunteur une première déclaration qui comporte, outre les renseignements visés aux alinéas 10(1)a) et c) à k), les renseignements suivants :
	...
	- **e)** la mention indiquant que l’emprunteur qui avise la banque oralement ou par écrit de la perte ou du vol d’une carte de crédit n’est pas responsable de son utilisation non autorisée à partir du moment où la banque reçoit l’avis.
...
- **(5)** La banque émettrice de cartes de crédit doit remettre périodiquement à l’emprunteur, au moins une fois par mois, une déclaration indiquant l’information visée aux paragraphes 10(3) et (4) sauf les alinéas 10(3)b) et c) et comportant :
