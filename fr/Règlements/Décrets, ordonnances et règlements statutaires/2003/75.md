...
- **(1)** Tout producteur doit payer, pour chaque douzaine d’oeufs qu’il commercialise sur le marché interprovincial ou d’exportation, la redevance suivante :
	- **a)** dans la province d’Ontario, 0,3145 $;
	- **b)** dans la province de Québec, 0,3095 $;
	- **c)** dans la province de la Nouvelle-Écosse, 0,3185 $;
	- **d)** dans la province du Nouveau-Brunswick, 0,3608 $;
	- **e)** dans la province du Manitoba, 0,3095 $;
	...
	- **i)** dans la province d’Alberta, 0,3813 $;
