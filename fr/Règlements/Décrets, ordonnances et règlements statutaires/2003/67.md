> [Aller à la version anglaise](/en/Regulations/Statutory%20Orders%20and%20Regulations/2003/67.md)
...
**5** Le paragraphe 495(7) de la Loi ne s’applique pas lorsque, en vertu de l’alinéa 495(2)f) de la Loi, la société d’assurance-vie acquiert le contrôle d’une entité dont les activités commerciales se limitent aux activités visées au paragraphe 3(1) ou acquiert ou augmente un intérêt de groupe financier dans une telle entité. Le présent article n’a pas pour effet de limiter l’application des paragraphes 3(2) et (3).
