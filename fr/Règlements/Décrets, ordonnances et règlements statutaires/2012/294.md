...
- **(2)** Le paiement n’est pas inférieur au minimum déterminé selon le paragraphe 8506(5) du [Règlement de l’impôt sur le revenu](/fr/Règlements/Codification%20des%20règlements%20du%20Canada/901-1000/C.R.C.,%20ch.%20945.md) et, pour toute année civile avant l’année où le participant atteint l’âge de 90 ans, n’est pas supérieur à la somme calculée selon la formule suivante :
```
A × B
```
où :
...
- **(1)** Pour l’application des alinéas 50(1)b) et (3)b), 53(4)b) et 54(2)b) de la Loi, est un régime d’épargne-retraite le régime d’épargne immobilisé restreint qui prévoit :
	- **a)** que les fonds ne peuvent être que :
