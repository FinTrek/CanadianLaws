...
- **a)** dans le cas des périodes de conformité visant le distillat autres que la première, à la valeur qu’il a attribuée à la variable DtG<sub>DG</sub> prévue au paragraphe (1) pour la période de conformité visant l’essence quand celle-ci correspond à la période de conformité visant le distillat;
